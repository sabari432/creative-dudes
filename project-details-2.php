                ...
                <div class="container">
                    <div class="page_header_content d-flex align-items-center justify-content-between">
                        ...
                        <ul class="breadcrumb d-flex align-items-center">
                            ...
                            <li><a href="project-1.php">Web Designing </a></li>
                            <li class="active">Projects Deatils</li>
                        </ul>
                    </div>
                </div>
            </div>        
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="gallery-image">
                                        <img src="../assets/img/portfolio/details/sl-01.avif" alt="img">
                                    </div>
                                </div>

                                <div class="swiper-slide">
                                    <div class="gallery-image">
                                        <img src="../assets/img/portfolio/details/sl-02.jpg" alt="img">
                                    </div>
                                </div>

                                <div class="swiper-slide">
                                    <div class="gallery-image">
                                        <img src="../assets/img/portfolio/details/sl-03.jpg" alt="img">
                                    </div>
                                </div>
                            </div>
                            <!-- Add Pagination -->
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="sidebar">
                                <div class="project-information">
                                    ...
                                    <ul>
                                        <li>
                                            <span class="data">Company :</span> <span class="value">Creative Dudes</span>
                                        </li>
                                        <li>
                                            <span class="data">Owner 's:</span> <span class="value">Sabareeswaran N,Santhosh V</span>
                                        </li>
                                        <li>
                                            <span class="data">Concept :</span> <span class="value">Web Design,E-Commerence,final year project.</span>
                                        </li>

                                        <li>
                                            <span class="data">Location:</span> <span class="value">Coimbatore,Tamilnadhu</span>
                                        </li>
                            ...
                            <div class="project-details_inner">
                                <div class="post_content">
									<div class="post-header">
										<h3 class="post-title">Creative Dudes Web Projects</h3>
									</div>
									<div class="fulltext">
										<p>
											Creative Dudes is a full-service design firm providing Web Designing, E-commerence, Final Year Project, Personal Blog programming. Our portfolio of completed work includes highly acclaimed and wining projects for clients around the country. 
										...
										<p>We design with people in mind and use every expertise at our disposal.Our practice connects communities and is committed to the stewardship of place, clients.</p>
										<ul class="point_order">
											<li>The talent at Creative Dude runs wide and deep. Across many wedsites and projects .</li>
											<li>Organized to deliver the most specialized service possible and enriched by the depth.</li>
											<li>The members of our team are among the most skilled professionals in the industry.</li>
										</ul>

                                        <p>
                                        Creative Dudes, a comprehensive design firm, offers a range of services such as web design, e-commerce solutions, final year project development, and personalized blog programming. Our portfolio showcases award-winning projects completed for clients nationwide.
                                        </p>

										<p>
											You don’t create unforgettable spaces all over the world with a single design tool. Our expertise in devloping people together is as broad as it is deep. It devlope from a variety of disciplines, each one contributing to the bigger structure and sustainable growth. More than 100+ projects fill our portfolio, but it’s the millions of people who experience them who matter most. Click on the images below to learn more below about the impact our projects have on communities.
										</p>
                                    ...
                                    <div class="related-posts">
                                        ...
                                        <div class="grid grid-3 gutter-15 clearfix"> 
                                            ...
                                            <div class="grid-item residences">
                                                <div class="thumb">
                                                    <img class="item_image" src="../assets/img/portfolio/0004.jpg" alt="" height="210px">
                                                    <div class="works-info">
                                                        <div class="label-text">
                                                            <h5><a href="index-11.php">Innovative web development</a></h5>
                                                            <h6><a href="#">Creative Dudes</a></h6>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>                          
                                            <div class="grid-item interiors"> 
                                                <div class="thumb">
                                                    <img class="item_image" src="../assets/img/portfolio/002.webp" alt="">
                                                    <div class="works-info">
                                                        <div class="label-text">
                                                            <h5><a href="index-11.php">A greater assortment of projects</a></h5>
                                                            <h6><a href="#">Creative Dudes</a>, <a href="#"></a></h6>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>                      
                                            <div class="grid-item residences"> 
                                                <div class="thumb">
                                                    <img class="item_image" src="../assets/img/portfolio/003.avif" alt="" height="210px">
                                                    <div class="works-info">
                                                        <div class="label-text">
                                                            <h5><a href="index-11.php">Formulate a fresh planning approach</a></h5>
                                                            <h6><a href="#">Creative Dudes</a>, <a href="#"></a></h6>
                                                        </div>
                                                    </div>
                                                </div>
...
<!-- Mirrored from wpthemebooster.com/demo/themeforest/php/mrittik/light/project-details.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 24 Dec 2023 13:46:28 GMT -->
</php>