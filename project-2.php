                    ...
                    <div class="grid grid-2 gutter-90 clearfix"> 
                            ...
                            <div class="thumb">
                                ...
                                <div class="works-info">
                                    <div class="label-text">
                                        <h5><a href="project-details.php">California young menz club</a></h5>
                        ...
                        <div class="grid-item interiors"> 
                            <div class="thumb">
                                ...
                                <div class="works-info">
                                    <div class="label-text">
                                        <h5><a href="project-details.php">Sunlight in the Room</a></h5>
                        ...
                        <div class="grid-item residences"> 
                            <div class="thumb">
                                ...
                                <div class="works-info">
                                    <div class="label-text">
                                        <h5><a href="project-details.php">Find your own self invintage lake house</a></h5>
                                        <h6><a href="#">Club House</a>, <a href="#">Interior</a></h6>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="grid-item landscape exterior"> 
                            <div class="thumb">
                                ...
                                <div class="works-info">
                                    <div class="label-text">
                                        <h5><a href="project-details.php">Well decor house in Sydney</a></h5>
                                        <h6><a href="#">Club House</a>, <a href="#">Interior</a></h6>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="grid-item landscape"> 
                            <div class="thumb">
                                ...
                                <div class="works-info">
                                    <div class="label-text">
                                        <h5><a href="project-details.php">Huge large area Bedroom</a></h5>
                                        <h6><a href="#">Club House</a>, <a href="#">Interior</a></h6>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="grid-item interiors">
                            <div class="thumb">
                                ...
                                <div class="works-info">
                                    <div class="label-text">
                                        <h5><a href="project-details.php">Clean water in the swiming pool</a></h5>
                                        <h6><a href="#">Club House</a>, <a href="#">Interior</a></h6>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="grid-item residences"> 
                            <div class="thumb">
                                ...
                                <div class="works-info">
                                    <div class="label-text">
                                        <h5><a href="project-details.php">Newyork golf club house</a></h5>
                                        <h6><a href="#">Club House</a>, <a href="#">Interior</a></h6>
                                    </div>
                                </div>
                            </div>
...
<!-- Mirrored from wpthemebooster.com/demo/themeforest/php/mrittik/light/project-2.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 24 Dec 2023 13:46:24 GMT -->
</php>