                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="gallery-image">
                                        <img src="../assets/img/portfolio/details/p4-1.jpeg" alt="img">
                                    </div>
                                </div>
                                    ...
                                    <div class="related-posts">
                                        ...
                                        <div class="grid grid-3 gutter-15 clearfix"> 
                                            ...
                                            <div class="grid-item residences">
                                                <div class="thumb">
                                                    <img class="item_image" src="../assets/img/portfolio/p4-1.jpg" alt="" height="210px">
                                                    <div class="works-info">
                                                        <div class="label-text">
                                                            <h5><a href="index-11.php">Projects specifically for college students</a></h5>
                                            ...
                                            <div class="grid-item interiors"> 
                                                <div class="thumb">
                                                    <img class="item_image" src="../assets/img/portfolio/p4-2.png" alt="" height="210px">
                                                    <div class="works-info">
                                                        <div class="label-text">
                                                            <h5><a href="index-11.php">Simplify the explanation of coding in our projects</a></h5>
                                            ...
                                            <div class="grid-item residences"> 
                                                <div class="thumb">
                                                    <img class="item_image" src="../assets/img/portfolio/p4-3.jpg" alt="" height="210px">
                                                    <div class="works-info">
                                                        <div class="label-text">
                                                            <h5><a href="index-11.php">Develop software and projects</a></h5>
                                                            <h6><a href="#">Creative Dudes</a>, <a href="#"></a></h6>
                                                        </div>
                                                    </div>
                                                </div>
