                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4" data-aos="fade-up" data-aos-duration="500">
                            <div class="icon_box">
                                <h6>01</h6>
                                <img src="../assets/img/team/11.png" alt="Icon Box" height="200px">
                                <h4 class="text-white"><a href="#">HTML & CSS </a></h4>
                                <p class="text-gray-600">Creative Dudes is a comprehensive design <br> firm that offers website creation services tailored to your specific needs, establishing  your online identity.</p>
                        ...
                        <div class="col-lg-4" data-aos="fade-up" data-aos-duration="700" >
                            <div class="icon_box">
                                <h6>02</h6>
                                <img src="../assets/img/team/12.png" alt="Icon Box" height="200px">
                                <h4 class="text-white"><a href="#">java script </a></h4>
                                <p class="text-gray-600">Creative Dudes is a flexible design agency offering personalized website creation services to meet your specific needs, along with innovative options to enhance and optimize your website.</p>
                                <div class="arrow_effect">
                                    <a href="#"><span class="crossline1"></span><span class="crossline2"></span></a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4" data-aos="fade-up" data-aos-duration="900">
                            <div class="icon_box">
                                <h6>03</h6>
                                <img src="../assets/img/team/05.jpg" alt="Icon Box" height="200px">
                                <h4 class="text-white"><a href="#">php </a></h4>
                                <p class="text-gray-600">Creative Dudes is a versatile design agency that provides customized website creation services to suit your individual requirements, helping to establish your online identity.</p>
                                <div class="arrow_effect">
                                    <a href="#"><span class="crossline1"></span><span class="crossline2"></span></a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4" data-aos="fade-up" data-aos-duration="1100">
                            <div class="icon_box">
                                <h6>04</h6>
                                <img src="../assets/img/team/13.png" alt="Icon Box" height="270px">
                                <h4 class="text-white"><a href="#">angular js</a></h4>
                                <p class="text-gray-600">Creative Dudes is a dynamic design agency specializing in tailored website creation <br> services to meet your unique requirements, incorporating a customized framework by utilizing various tools.</p>
                                <div class="arrow_effect">
                                    <a href="#"><span class="crossline1"></span><span class="crossline2"></span></a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4" data-aos="fade-up" data-aos-duration="1300">
                            <div class="icon_box">
                                <h6>05</h6>
                                <img src="../assets/img/team/14.png" alt="Icon Box" height="270px">
                                <h4 class="text-white"><a href="#">react js </a></h4>
                                <p class="text-gray-600">Creative Dudes is a dynamic design agency specializing in tailored website creation <br> services to meet your unique requirements, incorporating a customized framework by utilizing various tools.</p>
                                <div class="arrow_effect">
                                    <a href="#"><span class="crossline1"></span><span class="crossline2"></span></a>
                                </div>
                        ...
                        <div class="col-lg-4" data-aos="fade-up" data-aos-duration="1500">
                            <div class="icon_box">
                                <h6>06</h6>
                                <img src="../assets/img/team/04.jpg" alt="Icon Box"  height="270px">
                                <h4 class="text-white"><a href="#">my sql </a></h4>
                                <p class="text-gray-600">Creative Dudes, a versatile design agency, provides personalized website creation services designed to meet your specific requirements. Utilizing secure tools, we ensure the safe and protected storage of your data and information.</p>
                                <div class="arrow_effect">
                                    <a href="#"><span class="crossline1"></span><span class="crossline2"></span></a>
                                </div>
                            </div>
