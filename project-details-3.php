                ...
                <div class="container">
                    <div class="page_header_content d-flex align-items-center justify-content-between">
                        ...
                        <ul class="breadcrumb d-flex align-items-center">
                            ...
                            <li><a href="project-1.php">E-commerence</a></li>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="gallery-image">
                                        <img src="../assets/img/portfolio/details/01.jpg" alt="img">
                                    </div>
                                </div>
                                    ...
                                    <div class="related-posts">
                                        ...
                                        <div class="grid grid-3 gutter-15 clearfix"> 
                                            ...
                                            <div class="grid-item residences">
                                                <div class="thumb">
                                                    <img class="item_image" src="../assets/img/portfolio/p3-1.jpg" alt="" height="210px">
                                                    <div class="works-info">
                                                        <div class="label-text">
                                                            <h5><a href="index-11.php">Top-notch E-commerce websites</a></h5>
                                            ...
                                            <div class="grid-item interiors"> 
                                                <div class="thumb">
                                                    <img class="item_image" src="../assets/img/portfolio/p3-2.jpg" alt="">
                                                    <div class="works-info">
                                                        <div class="label-text">
                                                            <h5><a href="index-11.php">A website for e-commerce with responsive design</a></h5>
                                            ...
                                            <div class="grid-item residences"> 
                                                <div class="thumb">
                                                    <img class="item_image" src="../assets/img/portfolio/p3-3.jpg" alt="" height="210px">
                                                    <div class="works-info">
                                                        <div class="label-text">
                                                            <h5><a href="index-11.php">Exceptional e-commerce websites</a></h5>
                                                            <h6><a href="#">Creative Dudes</a>, <a href="#"></a></h6>
                                                        </div>
                                                    </div>
                                                </div>
