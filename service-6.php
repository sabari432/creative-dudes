                ...
                <div class="footer_inner pb-0">
                    <div class="footer_elements d-flex align-items-center justify-content-center">
                        <div class="footer_elements_inner">
                            ...
                            <div class="copyright">
                                <p>Creative Dudes 2023. All Rights Reserved</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4" data-aos="fade-up" data-aos-duration="500">
                            <div class="icon_box">
                                <h6>01</h6>
                                <img src="../assets/img/team/32.webp" alt="Icon Box" height="200px">
                                <h4 class="text-white"><a href="#">BRANDING SERVICE</a></h4>
                                <p class="text-gray-600">A branding service involves creating and managing a brand identity for a business or individual. This includes developing a unique brand image, positioning, and messaging to distinguish the entity from competitors and connect with target audiences.</p>
                        ...
                        <div class="col-lg-4" data-aos="fade-up" data-aos-duration="700" >
                            <div class="icon_box">
                                <h6>02</h6>
                                <img src="../assets/img/team/33.jpg" alt="Icon Box" height="200px">
                                <h4 class="text-white"><a href="#">WEB DEVELOPMENT</a></h4>
                                <p class="text-gray-600">Creative Dudes provided a Website design refers to the process of creating the visual appearance and layout of a website. This includes elements such as the overall structure, color scheme, typography, images, and interactive features.</p>
                                <div class="arrow_effect">
                                    <a href="#"><span class="crossline1"></span><span class="crossline2"></span></a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4" data-aos="fade-up" data-aos-duration="900">
                            <div class="icon_box">
                                <h6>03</h6>
                                <img src="../assets/img/team/36.webp" alt="Icon Box" height="200px">
                                <h4 class="text-white"><a href="#">MARKETING</a></h4>
                                <p class="text-gray-600"> It involves understanding customer needs and preferences, creating products that meet those needs, and communicating the value of those products to potential customers.</p>
                                <div class="arrow_effect">
                                    <a href="#"><span class="crossline1"></span><span class="crossline2"></span></a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4" data-aos="fade-up" data-aos-duration="1100">
                            <div class="icon_box">
                                <h6>04</h6>
                                <img src="../assets/img/team/35.jpg" alt="Icon Box" height="270px">
                                <h4 class="text-white"><a href="#">DESIGN RESEARCH</a></h4>
                                <p class="text-gray-600"> the systematic investigation and study of various aspects related to design. This type of research is conducted to gain insights into users, markets, technologies, and other factors that influence the design process.</p>
                                <div class="arrow_effect">
                                    <a href="#"><span class="crossline1"></span><span class="crossline2"></span></a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4" data-aos="fade-up" data-aos-duration="1300">
                            <div class="icon_box">
                                <h6>05</h6>
                                <img src="../assets/img/team/37.jpg" alt="Icon Box" height="270px">
                                <h4 class="text-white"><a href="#">ANY TIME SERVICE</a></h4>
                                <p class="text-gray-600"> a service or assistance that is available whenever it is needed, without specific limitations on when it can be accessed. This could apply to various types of services, such as customer support, emergency services, or online platforms that operate 24/7. </p>
                                <div class="arrow_effect">
                                    <a href="#"><span class="crossline1"></span><span class="crossline2"></span></a>
                                </div>
                            </div>
