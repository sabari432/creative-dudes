            ...
            <div class="page_header_inner">
                <div class="container">
                    <div class="page_header_content d-flex align-items-center justify-content-between">
                        <h2 class="heading">STATIC WEB SERVICE</h2>
                    </div>
                </div>
            </div>        
        </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4" data-aos="fade-up" data-aos-duration="500">
                            <div class="icon_box">
                                <h6>01</h6>
                                <img src="../assets/img/team/38.jpg" alt="Icon Box" height="200px">
                                <h4 class="text-white"><a href="#">FIXED CONTENT</a></h4>
                                <p class="text-gray-600">This content is typically used for important information that should always be visible to the user, such as navigation menus, headers, footers, or critical announcements.</p>
                        ...
                        <div class="col-lg-4" data-aos="fade-up" data-aos-duration="700" >
                            <div class="icon_box">
                                <h6>02</h6>
                                <img src="../assets/img/team/39.jpg" alt="Icon Box" height="200px">
                                <h4 class="text-white"><a href="#">COST_EFFECTIVE</a></h4>
                                <p class="text-gray-600">Cost-effective web solutions typically focus on providing value without excessive expenses. Here are some aspects to consider for cost-effective web development and create a cost-effective web presence that meets your needs .</p>
                                <div class="arrow_effect">
                                    <a href="#"><span class="crossline1"></span><span class="crossline2"></span></a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4" data-aos="fade-up" data-aos-duration="900">
                            <div class="icon_box">
                                <h6>03</h6>
                                <img src="../assets/img/team/42.jpeg" alt="Icon Box" height="200px">
                                <h4 class="text-white"><a href="#">SECURITY</a></h4>
                                <p class="text-gray-600">Web security is a critical aspect of online presence, encompassing measures and protocols to protect websites and web applications from cyber threats.</p>
                                <div class="arrow_effect">
                                    <a href="#"><span class="crossline1"></span><span class="crossline2"></span></a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4" data-aos="fade-up" data-aos-duration="1100">
                            <div class="icon_box">
                                <h6>04</h6>
                                <img src="../assets/img/team/43.jpg" alt="Icon Box" height="270px">
                                <h4 class="text-white"><a href="#">EASE OF DEPLOYMENT</a></h4>
                                <p class="text-gray-600">The ease of deployment in web development refers to how quickly and smoothly a web application or website can be set up and made accessible to users.</p>
                                <div class="arrow_effect">
                                    <a href="#"><span class="crossline1"></span><span class="crossline2"></span></a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4" data-aos="fade-up" data-aos-duration="1300">
                            <div class="icon_box">
                                <h6>05</h6>
                                <img src="../assets/img/team/44.webp" alt="Icon Box" height="270px">
                                <h4 class="text-white"><a href="#">EFFICIENCY</a></h4>
                                <p class="text-gray-600"> Efficient time management involves prioritizing tasks, setting goals, and minimizing distractions.Efficiency is about doing more with less, saving time, money, and resources while achieving desired results.</p>
                                <div class="arrow_effect">
                                    <a href="#"><span class="crossline1"></span><span class="crossline2"></span></a>
                                </div>
                            </div>
