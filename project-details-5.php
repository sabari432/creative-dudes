                ...
                <div class="container">
                    <div class="page_header_content d-flex align-items-center justify-content-between">
                        ...
                        <ul class="breadcrumb d-flex align-items-center">
                            ...
                            <li><a href="project-1.php">Personal Blog</a></li>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="gallery-image">
                                        <img src="../assets/img/slider/05.png" alt="img">
                                    </div>
                                </div>
                                    ...
                                    <div class="related-posts">
                                        ...
                                        <div class="grid grid-3 gutter-15 clearfix"> 
                                            ...
                                            <div class="grid-item residences">
                                                <div class="thumb">
                                                    <img class="item_image" src="../assets/img/portfolio/p5-2.jpg" alt="" height="210px">
                                                    <div class="works-info">
                                                        <div class="label-text">
                                                            <h5><a href="index-11.php">Creating a cutting-edge portfolio that showcases innovation</a></h5>
                                            ...
                                            <div class="grid-item interiors"> 
                                                <div class="thumb">
                                                    <img class="item_image" src="../assets/img/portfolio/p5-3.png" alt="" height="210px">
                                                    <div class="works-info">
                                                        <div class="label-text">
                                                            <h5><a href="index-11.php">Briefly describe and elucidate the concept of a portfolio</a></h5>
                                            ...
                                            <div class="grid-item residences"> 
                                                <div class="thumb">
                                                    <img class="item_image" src="../assets/img/portfolio/p5-4.png" alt="" height="210px">
                                                    <div class="works-info">
                                                        <div class="label-text">
                                                            <h5><a href="index-11.php">The Diverse Advantages Offered by a Web Designer's Portfolio</a></h5>
                                                            <h6><a href="#">Creative Dudes</a>, <a href="#"></a></h6>
                                                        </div>
                                                    </div>
                                                </div>
